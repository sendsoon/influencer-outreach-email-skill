...
1 通につき 1 人のクリエイター。製品または協業の説明があれば始める。氏名・メール・チャンネルは CSV / Excel / TXT / テーブル / Google スプレッドシートがあればそこから取る。リストがなければデータ源を一度だけ確認する。それでも欠けていれば「the creator / クリエイター」などの代称を使い、個別には聞かない。
